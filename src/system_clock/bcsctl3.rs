...
pub type LFXT1OF_W<'a, const O: u8> = crate::BitWriter<'a, BCSCTL3_SPEC, O>;
...
pub type XT2OF_W<'a, const O: u8> = crate::BitWriter<'a, BCSCTL3_SPEC, O>;
...
pub type XCAP_W<'a, const O: u8> = crate::FieldWriterSafe<'a, BCSCTL3_SPEC, 2, O, XCAP_A>;
...
pub type LFXT1S_W<'a, const O: u8> = crate::FieldWriterSafe<'a, BCSCTL3_SPEC, 2, O, LFXT1S_A>;
...
pub type XT2S_W<'a, const O: u8> = crate::FieldWriterSafe<'a, BCSCTL3_SPEC, 2, O, XT2S_A>;
