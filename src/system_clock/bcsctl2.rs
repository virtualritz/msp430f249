...
pub type DCOR_W<'a, const O: u8> = crate::BitWriter<'a, BCSCTL2_SPEC, O>;
...
pub type DIVS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, BCSCTL2_SPEC, 2, O, DIVS_A>;
...
pub type SELS_W<'a, const O: u8> = crate::BitWriter<'a, BCSCTL2_SPEC, O>;
...
pub type DIVM_W<'a, const O: u8> = crate::FieldWriterSafe<'a, BCSCTL2_SPEC, 2, O, DIVM_A>;
...
pub type SELM_W<'a, const O: u8> = crate::FieldWriterSafe<'a, BCSCTL2_SPEC, 2, O, SELM_A>;
