...
pub type UCALIFG_W<'a, const O: u8> = crate::BitWriter<'a, UCB0STAT_SPEC, O>;
...
pub type UCSTTIFG_W<'a, const O: u8> = crate::BitWriter<'a, UCB0STAT_SPEC, O>;
...
pub type UCSTPIFG_W<'a, const O: u8> = crate::BitWriter<'a, UCB0STAT_SPEC, O>;
...
pub type UCNACKIFG_W<'a, const O: u8> = crate::BitWriter<'a, UCB0STAT_SPEC, O>;
#[doc = "Field `UCBBUSY` reader - Bus Busy Flag"]
pub type UCBBUSY_R = crate::BitReader;
#[doc = "Field `UCBBUSY` writer - Bus Busy Flag"]
pub type UCBBUSY_W<'a, const O: u8> = crate::BitWriter<'a, UCB0STAT_SPEC, O>;
