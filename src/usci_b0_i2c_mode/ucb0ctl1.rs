...
pub type UCTR_W<'a, const O: u8> = crate::BitWriter<'a, UCB0CTL1_SPEC, O>;
...
pub type UCSSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, UCB0CTL1_SPEC, 2, O, UCSSEL_A>;
