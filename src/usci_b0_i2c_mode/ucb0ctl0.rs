...
pub type UCSYNC_W<'a, const O: u8> = crate::BitWriter<'a, UCB0CTL0_SPEC, O>;
...
pub type UCMODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, UCB0CTL0_SPEC, 2, O, UCMODE_A>;
...
pub type UCMST_W<'a, const O: u8> = crate::BitWriter<'a, UCB0CTL0_SPEC, O>;
...
pub type UCMM_W<'a, const O: u8> = crate::BitWriter<'a, UCB0CTL0_SPEC, O>;
...
pub type UCSLA10_W<'a, const O: u8> = crate::BitWriter<'a, UCB0CTL0_SPEC, O>;
#[doc = "Field `UCA10` reader - 10-bit Address Mode"]
pub type UCA10_R = crate::BitReader;
#[doc = "Field `UCA10` writer - 10-bit Address Mode"]
pub type UCA10_W<'a, const O: u8> = crate::BitWriter<'a, UCB0CTL0_SPEC, O>;
impl R {
