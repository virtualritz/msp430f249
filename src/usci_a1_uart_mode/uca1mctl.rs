...
pub struct R(crate::R<UCA1MCTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCA1MCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCA1MCTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCA1MCTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCA1MCTL` writer"]
pub struct W(crate::W<UCA1MCTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCA1MCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCA1MCTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCA1MCTL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCOS16_W<'a, const O: u8> = crate::BitWriter<'a, UCA1MCTL_SPEC, O>;
...
pub type UCBRS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, UCA1MCTL_SPEC, 3, O, UCBRS_A>;
impl<'a, const O: u8> UCBRS_W<'a, O> {
...
pub type UCBRF_W<'a, const O: u8> = crate::FieldWriterSafe<'a, UCA1MCTL_SPEC, 4, O, UCBRF_A>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucbrs(&mut self) -> UCBRS_W<1> {
        UCBRS_W::new(self)
    }
    #[doc = "Bits 4:7 - USCI First Stage Modulation Select 3"]
    #[inline(always)]
