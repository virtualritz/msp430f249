...
pub type UCABDEN_W<'a, const O: u8> = crate::BitWriter<'a, UCA1ABCTL_SPEC, O>;
#[doc = "Field `UCBTOE` reader - Break Timeout error"]
pub type UCBTOE_R = crate::BitReader;
#[doc = "Field `UCBTOE` writer - Break Timeout error"]
pub type UCBTOE_W<'a, const O: u8> = crate::BitWriter<'a, UCA1ABCTL_SPEC, O>;
...
pub type UCSTOE_W<'a, const O: u8> = crate::BitWriter<'a, UCA1ABCTL_SPEC, O>;
...
pub type UCDELIM0_W<'a, const O: u8> = crate::BitWriter<'a, UCA1ABCTL_SPEC, O>;
...
pub type UCDELIM1_W<'a, const O: u8> = crate::BitWriter<'a, UCA1ABCTL_SPEC, O>;
impl R {
