...
pub type UCIREN_W<'a, const O: u8> = crate::BitWriter<'a, UCA1IRTCTL_SPEC, O>;
...
pub type UCIRTXCLK_W<'a, const O: u8> = crate::BitWriter<'a, UCA1IRTCTL_SPEC, O>;
...
pub type UCIRTXPL0_W<'a, const O: u8> = crate::BitWriter<'a, UCA1IRTCTL_SPEC, O>;
...
pub type UCIRTXPL1_W<'a, const O: u8> = crate::BitWriter<'a, UCA1IRTCTL_SPEC, O>;
...
pub type UCIRTXPL2_W<'a, const O: u8> = crate::BitWriter<'a, UCA1IRTCTL_SPEC, O>;
...
pub type UCIRTXPL3_W<'a, const O: u8> = crate::BitWriter<'a, UCA1IRTCTL_SPEC, O>;
...
pub type UCIRTXPL4_W<'a, const O: u8> = crate::BitWriter<'a, UCA1IRTCTL_SPEC, O>;
...
pub type UCIRTXPL5_W<'a, const O: u8> = crate::BitWriter<'a, UCA1IRTCTL_SPEC, O>;
impl R {
