...
pub type BUSY_W<'a, const O: u8> = crate::BitWriter<'a, FCTL3_SPEC, O>;
...
pub type KEYV_W<'a, const O: u8> = crate::BitWriter<'a, FCTL3_SPEC, O>;
...
pub type ACCVIFG_W<'a, const O: u8> = crate::BitWriter<'a, FCTL3_SPEC, O>;
...
pub type WAIT_W<'a, const O: u8> = crate::BitWriter<'a, FCTL3_SPEC, O>;
...
pub type LOCK_W<'a, const O: u8> = crate::BitWriter<'a, FCTL3_SPEC, O>;
#[doc = "Field `EMEX` reader - Flash Emergency Exit"]
pub type EMEX_R = crate::BitReader;
#[doc = "Field `EMEX` writer - Flash Emergency Exit"]
pub type EMEX_W<'a, const O: u8> = crate::BitWriter<'a, FCTL3_SPEC, O>;
...
pub type LOCKA_W<'a, const O: u8> = crate::BitWriter<'a, FCTL3_SPEC, O>;
...
pub type FAIL_W<'a, const O: u8> = crate::BitWriter<'a, FCTL3_SPEC, O>;
impl R {
