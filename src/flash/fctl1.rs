...
pub type ERASE_W<'a, const O: u8> = crate::BitWriter<'a, FCTL1_SPEC, O>;
...
pub type MERAS_W<'a, const O: u8> = crate::BitWriter<'a, FCTL1_SPEC, O>;
#[doc = "Field `EEI` reader - Enable Erase Interrupts"]
pub type EEI_R = crate::BitReader;
#[doc = "Field `EEI` writer - Enable Erase Interrupts"]
pub type EEI_W<'a, const O: u8> = crate::BitWriter<'a, FCTL1_SPEC, O>;
...
pub type EEIEX_W<'a, const O: u8> = crate::BitWriter<'a, FCTL1_SPEC, O>;
...
pub type WRT_W<'a, const O: u8> = crate::BitWriter<'a, FCTL1_SPEC, O>;
...
pub type BLKWRT_W<'a, const O: u8> = crate::BitWriter<'a, FCTL1_SPEC, O>;
impl R {
