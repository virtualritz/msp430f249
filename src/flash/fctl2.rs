...
pub type FN0_R = crate::BitReader;
#[doc = "Field `FN0` writer - Divide Flash clock by 1 to 64 using FN0 to FN5 according to:"]
pub type FN0_W<'a, const O: u8> = crate::BitWriter<'a, FCTL2_SPEC, O>;
#[doc = "Field `FN1` reader - 32*FN5 + 16*FN4 + 8*FN3 + 4*FN2 + 2*FN1 + FN0 + 1"]
pub type FN1_R = crate::BitReader;
#[doc = "Field `FN1` writer - 32*FN5 + 16*FN4 + 8*FN3 + 4*FN2 + 2*FN1 + FN0 + 1"]
pub type FN1_W<'a, const O: u8> = crate::BitWriter<'a, FCTL2_SPEC, O>;
#[doc = "Field `FN2` reader - FN2"]
pub type FN2_R = crate::BitReader;
#[doc = "Field `FN2` writer - FN2"]
pub type FN2_W<'a, const O: u8> = crate::BitWriter<'a, FCTL2_SPEC, O>;
#[doc = "Field `FN3` reader - FN3"]
pub type FN3_R = crate::BitReader;
#[doc = "Field `FN3` writer - FN3"]
pub type FN3_W<'a, const O: u8> = crate::BitWriter<'a, FCTL2_SPEC, O>;
#[doc = "Field `FN4` reader - FN4"]
pub type FN4_R = crate::BitReader;
#[doc = "Field `FN4` writer - FN4"]
pub type FN4_W<'a, const O: u8> = crate::BitWriter<'a, FCTL2_SPEC, O>;
#[doc = "Field `FN5` reader - FN5"]
pub type FN5_R = crate::BitReader;
#[doc = "Field `FN5` writer - FN5"]
pub type FN5_W<'a, const O: u8> = crate::BitWriter<'a, FCTL2_SPEC, O>;
...
pub type FSSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, FCTL2_SPEC, 2, O, FSSEL_A>;
