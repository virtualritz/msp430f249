...
pub struct R(crate::R<UCB0RXBUF_SPI_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCB0RXBUF_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCB0RXBUF_SPI_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCB0RXBUF_SPI_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCB0RXBUF_SPI` writer"]
pub struct W(crate::W<UCB0RXBUF_SPI_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCB0RXBUF_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCB0RXBUF_SPI_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCB0RXBUF_SPI_SPEC>) -> Self {
        W(writer)
    }
}
