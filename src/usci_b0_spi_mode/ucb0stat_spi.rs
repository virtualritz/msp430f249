...
pub struct R(crate::R<UCB0STAT_SPI_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCB0STAT_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCB0STAT_SPI_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCB0STAT_SPI_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCB0STAT_SPI` writer"]
pub struct W(crate::W<UCB0STAT_SPI_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCB0STAT_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCB0STAT_SPI_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCB0STAT_SPI_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCBUSY_W<'a, const O: u8> = crate::BitWriter<'a, UCB0STAT_SPI_SPEC, O>;
...
#[doc = "USCI B0 Status Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ucb0stat_spi](index.html) module"]
pub struct UCB0STAT_SPI_SPEC;
impl crate::RegisterSpec for UCB0STAT_SPI_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [ucb0stat_spi::R](R) reader structure"]
impl crate::Readable for UCB0STAT_SPI_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucb0stat_spi::W](W) writer structure"]
impl crate::Writable for UCB0STAT_SPI_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UCB0STAT_SPI to value 0"]
impl crate::Resettable for UCB0STAT_SPI_SPEC {
