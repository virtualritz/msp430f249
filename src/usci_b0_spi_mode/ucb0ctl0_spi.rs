...
pub struct R(crate::R<UCB0CTL0_SPI_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCB0CTL0_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCB0CTL0_SPI_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCB0CTL0_SPI_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCB0CTL0_SPI` writer"]
pub struct W(crate::W<UCB0CTL0_SPI_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCB0CTL0_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCB0CTL0_SPI_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCB0CTL0_SPI_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCSYNC_W<'a, const O: u8> = crate::BitWriter<'a, UCB0CTL0_SPI_SPEC, O>;
...
pub type UCMODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, UCB0CTL0_SPI_SPEC, 2, O, UCMODE_A>;
...
pub type UCMST_W<'a, const O: u8> = crate::BitWriter<'a, UCB0CTL0_SPI_SPEC, O>;
...
pub type UC7BIT_W<'a, const O: u8> = crate::BitWriter<'a, UCB0CTL0_SPI_SPEC, O>;
...
pub type UCMSB_W<'a, const O: u8> = crate::BitWriter<'a, UCB0CTL0_SPI_SPEC, O>;
...
pub type UCCKPL_W<'a, const O: u8> = crate::BitWriter<'a, UCB0CTL0_SPI_SPEC, O>;
...
pub type UCCKPH_W<'a, const O: u8> = crate::BitWriter<'a, UCB0CTL0_SPI_SPEC, O>;
impl R {
...
pub struct UCB0CTL0_SPI_SPEC;
impl crate::RegisterSpec for UCB0CTL0_SPI_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [ucb0ctl0_spi::R](R) reader structure"]
impl crate::Readable for UCB0CTL0_SPI_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ucb0ctl0_spi::W](W) writer structure"]
impl crate::Writable for UCB0CTL0_SPI_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UCB0CTL0_SPI to value 0"]
impl crate::Resettable for UCB0CTL0_SPI_SPEC {
