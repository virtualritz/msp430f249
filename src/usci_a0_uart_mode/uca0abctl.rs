...
pub type UCABDEN_W<'a, const O: u8> = crate::BitWriter<'a, UCA0ABCTL_SPEC, O>;
#[doc = "Field `UCBTOE` reader - Break Timeout error"]
pub type UCBTOE_R = crate::BitReader;
#[doc = "Field `UCBTOE` writer - Break Timeout error"]
pub type UCBTOE_W<'a, const O: u8> = crate::BitWriter<'a, UCA0ABCTL_SPEC, O>;
...
pub type UCSTOE_W<'a, const O: u8> = crate::BitWriter<'a, UCA0ABCTL_SPEC, O>;
...
pub type UCDELIM0_W<'a, const O: u8> = crate::BitWriter<'a, UCA0ABCTL_SPEC, O>;
...
pub type UCDELIM1_W<'a, const O: u8> = crate::BitWriter<'a, UCA0ABCTL_SPEC, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ucdelim0(&mut self) -> UCDELIM0_W<4> {
        UCDELIM0_W::new(self)
    }
    #[doc = "Bit 5 - Break Sync Delimiter 1"]
    #[inline(always)]
    #[must_use]
    pub fn ucdelim1(&mut self) -> UCDELIM1_W<5> {
        UCDELIM1_W::new(self)
    }
