...
pub type UCSYNC_W<'a, const O: u8> = crate::BitWriter<'a, UCA0CTL0_SPEC, O>;
...
pub type UCMODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, UCA0CTL0_SPEC, 2, O, UCMODE_A>;
...
pub type UCSPB_W<'a, const O: u8> = crate::BitWriter<'a, UCA0CTL0_SPEC, O>;
...
pub type UC7BIT_W<'a, const O: u8> = crate::BitWriter<'a, UCA0CTL0_SPEC, O>;
...
pub type UCMSB_W<'a, const O: u8> = crate::BitWriter<'a, UCA0CTL0_SPEC, O>;
...
pub type UCPAR_W<'a, const O: u8> = crate::BitWriter<'a, UCA0CTL0_SPEC, O>;
...
pub type UCPEN_W<'a, const O: u8> = crate::BitWriter<'a, UCA0CTL0_SPEC, O>;
impl R {
