...
pub type UCIRRXFE_W<'a, const O: u8> = crate::BitWriter<'a, UCA0IRRCTL_SPEC, O>;
...
pub type UCIRRXPL_W<'a, const O: u8> = crate::BitWriter<'a, UCA0IRRCTL_SPEC, O>;
...
pub type UCIRRXFL0_W<'a, const O: u8> = crate::BitWriter<'a, UCA0IRRCTL_SPEC, O>;
...
pub type UCIRRXFL1_W<'a, const O: u8> = crate::BitWriter<'a, UCA0IRRCTL_SPEC, O>;
...
pub type UCIRRXFL2_W<'a, const O: u8> = crate::BitWriter<'a, UCA0IRRCTL_SPEC, O>;
...
pub type UCIRRXFL3_W<'a, const O: u8> = crate::BitWriter<'a, UCA0IRRCTL_SPEC, O>;
...
pub type UCIRRXFL4_W<'a, const O: u8> = crate::BitWriter<'a, UCA0IRRCTL_SPEC, O>;
...
pub type UCIRRXFL5_W<'a, const O: u8> = crate::BitWriter<'a, UCA0IRRCTL_SPEC, O>;
impl R {
