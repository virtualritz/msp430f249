...
pub type UCSWRST_W<'a, const O: u8> = crate::BitWriter<'a, UCA0CTL1_SPEC, O>;
...
pub type UCTXBRK_W<'a, const O: u8> = crate::BitWriter<'a, UCA0CTL1_SPEC, O>;
...
pub type UCTXADDR_W<'a, const O: u8> = crate::BitWriter<'a, UCA0CTL1_SPEC, O>;
#[doc = "Field `UCDORM` reader - Dormant (Sleep) Mode"]
pub type UCDORM_R = crate::BitReader;
#[doc = "Field `UCDORM` writer - Dormant (Sleep) Mode"]
pub type UCDORM_W<'a, const O: u8> = crate::BitWriter<'a, UCA0CTL1_SPEC, O>;
...
pub type UCBRKIE_W<'a, const O: u8> = crate::BitWriter<'a, UCA0CTL1_SPEC, O>;
...
pub type UCRXEIE_W<'a, const O: u8> = crate::BitWriter<'a, UCA0CTL1_SPEC, O>;
...
pub type UCSSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, UCA0CTL1_SPEC, 2, O, UCSSEL_A>;
