...
pub type UCOS16_W<'a, const O: u8> = crate::BitWriter<'a, UCA0MCTL_SPEC, O>;
...
pub type UCBRS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, UCA0MCTL_SPEC, 3, O, UCBRS_A>;
...
pub type UCBRF_W<'a, const O: u8> = crate::FieldWriterSafe<'a, UCA0MCTL_SPEC, 4, O, UCBRF_A>;
