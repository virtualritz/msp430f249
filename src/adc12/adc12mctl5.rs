...
impl From<crate::R<ADC12MCTL5_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<ADC12MCTL5_SPEC>> for W {
    #[inline(always)]
...
pub type INCH_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ADC12MCTL5_SPEC, 4, O, INCH_A>;
...
pub type SREF_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ADC12MCTL5_SPEC, 3, O, SREF_A>;
...
pub type EOS_W<'a, const O: u8> = crate::BitWriter<'a, ADC12MCTL5_SPEC, O>;
impl R {
