...
pub type INCH_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ADC12MCTL3_SPEC, 4, O, INCH_A>;
...
pub type SREF_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ADC12MCTL3_SPEC, 3, O, SREF_A>;
...
pub type EOS_W<'a, const O: u8> = crate::BitWriter<'a, ADC12MCTL3_SPEC, O>;
impl R {
