...
pub struct R(crate::R<ADC12MEM3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ADC12MEM3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ADC12MEM3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ADC12MEM3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ADC12MEM3` writer"]
pub struct W(crate::W<ADC12MEM3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ADC12MEM3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ADC12MEM3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ADC12MEM3_SPEC>) -> Self {
        W(writer)
    }
}
