...
pub type ADC12BUSY_W<'a, const O: u8> = crate::BitWriter<'a, ADC12CTL1_SPEC, O>;
...
pub type CONSEQ_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ADC12CTL1_SPEC, 2, O, CONSEQ_A>;
...
pub type ADC12SSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, ADC12CTL1_SPEC, 2, O, ADC12SSEL_A>;
...
pub type ADC12DIV_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ADC12CTL1_SPEC, 3, O, ADC12DIV_A>;
...
pub type ISSH_W<'a, const O: u8> = crate::BitWriter<'a, ADC12CTL1_SPEC, O>;
#[doc = "Field `SHP` reader - ADC12 Sample/Hold Pulse Mode"]
pub type SHP_R = crate::BitReader;
#[doc = "Field `SHP` writer - ADC12 Sample/Hold Pulse Mode"]
pub type SHP_W<'a, const O: u8> = crate::BitWriter<'a, ADC12CTL1_SPEC, O>;
...
pub type SHS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ADC12CTL1_SPEC, 2, O, SHS_A>;
...
pub type CSTARTADD_R = crate::FieldReader<CSTARTADD_A>;
...
impl crate::FieldSpec for CSTARTADD_A {
    type Ux = u8;
}
impl CSTARTADD_R {
    #[doc = "Get enumerated values variant"]
...
pub type CSTARTADD_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, ADC12CTL1_SPEC, 4, O, CSTARTADD_A>;
