...
impl From<crate::R<ADC12MCTL2_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<ADC12MCTL2_SPEC>> for W {
    #[inline(always)]
...
pub type INCH_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ADC12MCTL2_SPEC, 4, O, INCH_A>;
...
pub type SREF_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ADC12MCTL2_SPEC, 3, O, SREF_A>;
...
pub type EOS_W<'a, const O: u8> = crate::BitWriter<'a, ADC12MCTL2_SPEC, O>;
impl R {
