...
pub type ADC12SC_W<'a, const O: u8> = crate::BitWriter<'a, ADC12CTL0_SPEC, O>;
#[doc = "Field `ENC` reader - ADC12 Enable Conversion"]
pub type ENC_R = crate::BitReader;
#[doc = "Field `ENC` writer - ADC12 Enable Conversion"]
pub type ENC_W<'a, const O: u8> = crate::BitWriter<'a, ADC12CTL0_SPEC, O>;
...
pub type ADC12TOVIE_W<'a, const O: u8> = crate::BitWriter<'a, ADC12CTL0_SPEC, O>;
...
pub type REF2_5V_W<'a, const O: u8> = crate::BitWriter<'a, ADC12CTL0_SPEC, O>;
...
pub type MSC_W<'a, const O: u8> = crate::BitWriter<'a, ADC12CTL0_SPEC, O>;
#[doc = "Field `SHT0` reader - ADC12 Sample Hold 0 Select 0"]
pub type SHT0_R = crate::FieldReader<SHT0_A>;
...
impl crate::FieldSpec for SHT0_A {
    type Ux = u8;
}
impl SHT0_R {
...
pub type SHT0_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ADC12CTL0_SPEC, 4, O, SHT0_A>;
...
pub type SHT1_R = crate::FieldReader<SHT1_A>;
#[doc = "ADC12 Sample Hold 0 Select 0\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum SHT1_A {
...
impl crate::FieldSpec for SHT1_A {
    type Ux = u8;
}
impl SHT1_R {
    #[doc = "Get enumerated values variant"]
...
pub type SHT1_W<'a, const O: u8> = crate::FieldWriterSafe<'a, ADC12CTL0_SPEC, 4, O, SHT1_A>;
