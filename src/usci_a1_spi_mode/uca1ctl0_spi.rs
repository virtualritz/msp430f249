...
pub struct R(crate::R<UCA1CTL0_SPI_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCA1CTL0_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCA1CTL0_SPI_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCA1CTL0_SPI_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCA1CTL0_SPI` writer"]
pub struct W(crate::W<UCA1CTL0_SPI_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCA1CTL0_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCA1CTL0_SPI_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCA1CTL0_SPI_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCSYNC_W<'a, const O: u8> = crate::BitWriter<'a, UCA1CTL0_SPI_SPEC, O>;
...
pub type UCMODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, UCA1CTL0_SPI_SPEC, 2, O, UCMODE_A>;
...
pub type UCMST_W<'a, const O: u8> = crate::BitWriter<'a, UCA1CTL0_SPI_SPEC, O>;
...
pub type UC7BIT_W<'a, const O: u8> = crate::BitWriter<'a, UCA1CTL0_SPI_SPEC, O>;
...
pub type UCMSB_W<'a, const O: u8> = crate::BitWriter<'a, UCA1CTL0_SPI_SPEC, O>;
...
pub type UCCKPL_W<'a, const O: u8> = crate::BitWriter<'a, UCA1CTL0_SPI_SPEC, O>;
...
pub type UCCKPH_W<'a, const O: u8> = crate::BitWriter<'a, UCA1CTL0_SPI_SPEC, O>;
impl R {
...
pub struct UCA1CTL0_SPI_SPEC;
impl crate::RegisterSpec for UCA1CTL0_SPI_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [uca1ctl0_spi::R](R) reader structure"]
impl crate::Readable for UCA1CTL0_SPI_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uca1ctl0_spi::W](W) writer structure"]
impl crate::Writable for UCA1CTL0_SPI_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UCA1CTL0_SPI to value 0"]
impl crate::Resettable for UCA1CTL0_SPI_SPEC {
