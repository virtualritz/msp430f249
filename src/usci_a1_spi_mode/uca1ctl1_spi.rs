...
pub struct R(crate::R<UCA1CTL1_SPI_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCA1CTL1_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCA1CTL1_SPI_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCA1CTL1_SPI_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCA1CTL1_SPI` writer"]
pub struct W(crate::W<UCA1CTL1_SPI_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCA1CTL1_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCA1CTL1_SPI_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCA1CTL1_SPI_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCSWRST_W<'a, const O: u8> = crate::BitWriter<'a, UCA1CTL1_SPI_SPEC, O>;
...
pub type UCSSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, UCA1CTL1_SPI_SPEC, 2, O, UCSSEL_A>;
