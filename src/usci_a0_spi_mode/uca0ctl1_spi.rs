...
pub struct R(crate::R<UCA0CTL1_SPI_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCA0CTL1_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCA0CTL1_SPI_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCA0CTL1_SPI_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCA0CTL1_SPI` writer"]
pub struct W(crate::W<UCA0CTL1_SPI_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCA0CTL1_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCA0CTL1_SPI_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCA0CTL1_SPI_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCSWRST_W<'a, const O: u8> = crate::BitWriter<'a, UCA0CTL1_SPI_SPEC, O>;
...
pub type UCSSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, UCA0CTL1_SPI_SPEC, 2, O, UCSSEL_A>;
...
pub struct UCA0CTL1_SPI_SPEC;
impl crate::RegisterSpec for UCA0CTL1_SPI_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [uca0ctl1_spi::R](R) reader structure"]
impl crate::Readable for UCA0CTL1_SPI_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uca0ctl1_spi::W](W) writer structure"]
impl crate::Writable for UCA0CTL1_SPI_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets UCA0CTL1_SPI to value 0"]
impl crate::Resettable for UCA0CTL1_SPI_SPEC {
