...
pub struct R(crate::R<UCA0RXBUF_SPI_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCA0RXBUF_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCA0RXBUF_SPI_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCA0RXBUF_SPI_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCA0RXBUF_SPI` writer"]
pub struct W(crate::W<UCA0RXBUF_SPI_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCA0RXBUF_SPI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCA0RXBUF_SPI_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCA0RXBUF_SPI_SPEC>) -> Self {
        W(writer)
    }
}
