...
pub struct R(crate::R<UCB1CTL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCB1CTL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCB1CTL1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCB1CTL1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCB1CTL1` writer"]
pub struct W(crate::W<UCB1CTL1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCB1CTL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCB1CTL1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCB1CTL1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCTR_W<'a, const O: u8> = crate::BitWriter<'a, UCB1CTL1_SPEC, O>;
...
pub type UCSSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, UCB1CTL1_SPEC, 2, O, UCSSEL_A>;
