...
pub struct R(crate::R<UCB1I2COA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCB1I2COA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCB1I2COA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCB1I2COA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCB1I2COA` writer"]
pub struct W(crate::W<UCB1I2COA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCB1I2COA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCB1I2COA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCB1I2COA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCGCEN_W<'a, const O: u8> = crate::BitWriter<'a, UCB1I2COA_SPEC, O>;
impl R {
