...
pub type SVSFG_R = crate::BitReader;
#[doc = "Field `SVSFG` writer - SVS Flag"]
pub type SVSFG_W<'a, const O: u8> = crate::BitWriter<'a, SVSCTL_SPEC, O>;
#[doc = "Field `SVSOP` reader - SVS output (read only)"]
pub type SVSOP_R = crate::BitReader;
#[doc = "Field `SVSOP` writer - SVS output (read only)"]
pub type SVSOP_W<'a, const O: u8> = crate::BitWriter<'a, SVSCTL_SPEC, O>;
#[doc = "Field `SVSON` reader - Switches the SVS on/off"]
pub type SVSON_R = crate::BitReader;
#[doc = "Field `SVSON` writer - Switches the SVS on/off"]
pub type SVSON_W<'a, const O: u8> = crate::BitWriter<'a, SVSCTL_SPEC, O>;
#[doc = "Field `PORON` reader - Enable POR Generation if Low Voltage"]
pub type PORON_R = crate::BitReader;
#[doc = "Field `PORON` writer - Enable POR Generation if Low Voltage"]
pub type PORON_W<'a, const O: u8> = crate::BitWriter<'a, SVSCTL_SPEC, O>;
#[doc = "Field `VLD0` reader - VLD0"]
pub type VLD0_R = crate::BitReader;
#[doc = "Field `VLD0` writer - VLD0"]
pub type VLD0_W<'a, const O: u8> = crate::BitWriter<'a, SVSCTL_SPEC, O>;
#[doc = "Field `VLD1` reader - VLD1"]
pub type VLD1_R = crate::BitReader;
#[doc = "Field `VLD1` writer - VLD1"]
pub type VLD1_W<'a, const O: u8> = crate::BitWriter<'a, SVSCTL_SPEC, O>;
#[doc = "Field `VLD2` reader - VLD2"]
pub type VLD2_R = crate::BitReader;
#[doc = "Field `VLD2` writer - VLD2"]
pub type VLD2_W<'a, const O: u8> = crate::BitWriter<'a, SVSCTL_SPEC, O>;
#[doc = "Field `VLD3` reader - VLD3"]
pub type VLD3_R = crate::BitReader;
#[doc = "Field `VLD3` writer - VLD3"]
pub type VLD3_W<'a, const O: u8> = crate::BitWriter<'a, SVSCTL_SPEC, O>;
impl R {
    #[doc = "Bit 0 - SVS Flag"]
    #[inline(always)]
