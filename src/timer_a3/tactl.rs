...
pub type TAIFG_W<'a, const O: u8> = crate::BitWriter<'a, TACTL_SPEC, O>;
...
pub type MC_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TACTL_SPEC, 2, O, MC_A>;
...
pub type ID_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TACTL_SPEC, 2, O, ID_A>;
...
pub type TASSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TACTL_SPEC, 2, O, TASSEL_A>;
