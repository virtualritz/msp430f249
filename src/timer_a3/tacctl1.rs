...
pub type CCIFG_W<'a, const O: u8> = crate::BitWriter<'a, TACCTL1_SPEC, O>;
...
pub type COV_W<'a, const O: u8> = crate::BitWriter<'a, TACCTL1_SPEC, O>;
...
pub type OUT_W<'a, const O: u8> = crate::BitWriter<'a, TACCTL1_SPEC, O>;
...
pub type CCI_W<'a, const O: u8> = crate::BitWriter<'a, TACCTL1_SPEC, O>;
...
pub type CCIE_W<'a, const O: u8> = crate::BitWriter<'a, TACCTL1_SPEC, O>;
...
pub type OUTMOD_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TACCTL1_SPEC, 3, O, OUTMOD_A>;
...
pub type CAP_W<'a, const O: u8> = crate::BitWriter<'a, TACCTL1_SPEC, O>;
...
pub type SCCI_W<'a, const O: u8> = crate::BitWriter<'a, TACCTL1_SPEC, O>;
#[doc = "Field `SCS` reader - Capture sychronize"]
pub type SCS_R = crate::BitReader;
#[doc = "Field `SCS` writer - Capture sychronize"]
pub type SCS_W<'a, const O: u8> = crate::BitWriter<'a, TACCTL1_SPEC, O>;
...
pub type CCIS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TACCTL1_SPEC, 2, O, CCIS_A>;
...
pub type CM_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TACCTL1_SPEC, 2, O, CM_A>;
