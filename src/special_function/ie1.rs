...
pub type WDTIE_W<'a, const O: u8> = crate::BitWriter<'a, IE1_SPEC, O>;
...
pub type ACCVIE_W<'a, const O: u8> = crate::BitWriter<'a, IE1_SPEC, O>;
impl R {
