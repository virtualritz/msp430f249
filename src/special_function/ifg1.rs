...
pub type WDTIFG_W<'a, const O: u8> = crate::BitWriter<'a, IFG1_SPEC, O>;
...
pub type OFIFG_W<'a, const O: u8> = crate::BitWriter<'a, IFG1_SPEC, O>;
...
pub type PORIFG_W<'a, const O: u8> = crate::BitWriter<'a, IFG1_SPEC, O>;
...
pub type RSTIFG_W<'a, const O: u8> = crate::BitWriter<'a, IFG1_SPEC, O>;
#[doc = "Field `NMIIFG` reader - NMI Interrupt Flag"]
pub type NMIIFG_R = crate::BitReader;
#[doc = "Field `NMIIFG` writer - NMI Interrupt Flag"]
pub type NMIIFG_W<'a, const O: u8> = crate::BitWriter<'a, IFG1_SPEC, O>;
impl R {
