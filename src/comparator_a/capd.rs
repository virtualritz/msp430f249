...
pub type CAPD0_W<'a, const O: u8> = crate::BitWriter<'a, CAPD_SPEC, O>;
...
pub type CAPD1_W<'a, const O: u8> = crate::BitWriter<'a, CAPD_SPEC, O>;
...
pub type CAPD2_W<'a, const O: u8> = crate::BitWriter<'a, CAPD_SPEC, O>;
...
pub type CAPD3_W<'a, const O: u8> = crate::BitWriter<'a, CAPD_SPEC, O>;
...
pub type CAPD4_W<'a, const O: u8> = crate::BitWriter<'a, CAPD_SPEC, O>;
...
pub type CAPD5_W<'a, const O: u8> = crate::BitWriter<'a, CAPD_SPEC, O>;
...
pub type CAPD6_W<'a, const O: u8> = crate::BitWriter<'a, CAPD_SPEC, O>;
...
pub type CAPD7_W<'a, const O: u8> = crate::BitWriter<'a, CAPD_SPEC, O>;
impl R {
