...
pub type CAIFG_W<'a, const O: u8> = crate::BitWriter<'a, CACTL1_SPEC, O>;
...
pub type CAIE_W<'a, const O: u8> = crate::BitWriter<'a, CACTL1_SPEC, O>;
...
pub type CAIES_W<'a, const O: u8> = crate::BitWriter<'a, CACTL1_SPEC, O>;
#[doc = "Field `CAON` reader - Comp. A enable"]
pub type CAON_R = crate::BitReader;
#[doc = "Field `CAON` writer - Comp. A enable"]
pub type CAON_W<'a, const O: u8> = crate::BitWriter<'a, CACTL1_SPEC, O>;
...
pub type CAREF_W<'a, const O: u8> = crate::FieldWriterSafe<'a, CACTL1_SPEC, 2, O, CAREF_A>;
...
pub type CARSEL_W<'a, const O: u8> = crate::BitWriter<'a, CACTL1_SPEC, O>;
#[doc = "Field `CAEX` reader - Comp. A Exchange Inputs"]
pub type CAEX_R = crate::BitReader;
#[doc = "Field `CAEX` writer - Comp. A Exchange Inputs"]
pub type CAEX_W<'a, const O: u8> = crate::BitWriter<'a, CACTL1_SPEC, O>;
impl R {
