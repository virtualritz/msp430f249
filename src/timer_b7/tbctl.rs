...
pub type TBIFG_W<'a, const O: u8> = crate::BitWriter<'a, TBCTL_SPEC, O>;
...
pub type MC_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TBCTL_SPEC, 2, O, MC_A>;
...
pub type ID_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TBCTL_SPEC, 2, O, ID_A>;
...
pub type TBSSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TBCTL_SPEC, 2, O, TBSSEL_A>;
...
pub type CNTL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TBCTL_SPEC, 2, O, CNTL_A>;
...
pub type TBCLGRP_W<'a, const O: u8> = crate::FieldWriterSafe<'a, TBCTL_SPEC, 2, O, TBCLGRP_A>;
